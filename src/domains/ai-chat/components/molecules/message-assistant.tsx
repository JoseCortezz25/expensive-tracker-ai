...
import { getMessageText } from '@/lib/util-message';
...
export const MessageAssistant = ({
  ...
  return (
    <div key={message.id} className="group justify-start">
      <div className="flex max-w-full flex-1 flex-col space-y-2 text-sm">
        ...
        {textContent && (
          <div className="text-foreground bg-transparent">{textContent}</div>
        )}
